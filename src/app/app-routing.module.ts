...
const routes: Routes = [
  {
    path: "department/:id/viewCategory/:id/viewSubcategory/:id/itemList",
    component: ViewItemListComponent
  },
  {
    path: "department/:id/viewCategory/:id/itemList",
    component: ViewItemListComponent
  },
  {
    path: "department/:id/viewCategory/:id/viewSubcategory",
